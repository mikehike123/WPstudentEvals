...
/**
 * Skill_levels_List_Table class
 */
class Skill_levels_List_Table extends WP_List_Table {
    /**
     * Constructor.
     *
     * @param void
    ...
    public function __construct() {
        parent::__construct( array(
            'singular' => __( 'Skill_level', 'mdccoder' ),
            'plural'   => __( 'Skill_levels', 'mdccoder' ),
            'ajax'     => false
        ) );
    }
    ...
    public function no_items() {
        _e( 'No skill_levels avaliable.', 'mdccoder' );
    }
...
case 'short_name':
    ...
    function column_name( $item ) {
        $delete_nonce = wp_create_nonce( 'mc_delete_skill_level' );
...
'short_name' => array( 'short_name', true ),
    ...
    public function prepare_items() {
        ...
        $total_items  = mc_get_skill_levels( $args );
        ...
        $this->items = mc_get_skill_levels( $args );
    }
}